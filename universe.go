...
type ancestryRepository interface {
	Ancestry(ctx context.Context, id uint) (*Ancestry, error)
	...
	UpdateAncestry(ctx context.Context, id uint, ancestry *Ancestry) (*Ancestry, error)
	DeleteAncestry(ctx context.Context, id uint) (bool, error)
}
